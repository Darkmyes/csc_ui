...
class _PreferenciasState extends State<Preferencias> {
  ...
  List<DropdownMenuItem> getSelectOptions(List<CategoriaAlimento> als) {
    ...
    als.forEach((item) {
      ...
      list.add(new DropdownMenuItem(child: Text(item.nombre), value: item.id));
    });
    return list;
  }
                              ...
                              if (_formKey.currentState.validate()) {
                                ...
                                if (_selectedItem == null) {
                                  Dialogs.mostrarDialog(context, "Error",
                                      "No seleccionó una Preferencia Alimenticia");
                                  return;
                                }
                                ...
                                UsuarioCtrl.insertPreferencia(id_usuario, pref)
                                    .then((value) {
                                  print(value);
                                  ...
                                  if (value == true) {
                                    ...
                                    setState(() {
                                      preferenciasUsuario =
                                          UsuarioCtrl.preferenciasUsuario(
                                              id_usuario);
                                    });
                                  } else {
                                    Dialogs.mostrarDialog(context, "Error",
                            ...
                            child: ListTile(
                              ...
                              trailing: new IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  UsuarioCtrl.deletePreferencia(
                                          id_usuario,
                                          snapshot
                                              .data[index].id_categoria_alimento
                                              .toString())
                                      .then((value) {
                                    Navigator.of(_keyLoader.currentContext,
                                            rootNavigator: true)
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  RaisedButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, '/alimentos_cuarentena',
