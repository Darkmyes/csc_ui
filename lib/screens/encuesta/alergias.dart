...
class _AlergiasState extends State<Alergias> {
  ...
  List<DropdownMenuItem> getSelectOptions(List<Alergia> als) {
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            child: Selector<EncuestaProvider,
                                Tuple2<List<Alergia>, bool>>(
                              selector: (context, model) =>
                                  Tuple2(model.alergias, model.loadingAlergias),
