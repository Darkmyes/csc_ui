...
class _EnfermedadesState extends State<Enfermedades> {
  ...
  List<DropdownMenuItem> getSelectOptions(List<Enfermedad> als) {
    // poner la lista que esta arriba devuelve list
    ...
    als.forEach((enfermedad) {
      ...
      list.add(new DropdownMenuItem(
          child: Text(enfermedad.nombre), value: enfermedad.id));
    });
    return list;
  }
  ...
  Widget build(BuildContext context) {
    ...
    id_usuario = Provider.of<UsuarioProvider>(context)
        .getUsuario()
        .id_usuario
        .toString();
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          IconButton(
                            ...
                            onPressed: () {
                              Navigator.pushNamed(
                                  context, "/registro_enfermedad");
                            },
                          ),
                          Expanded(
                            child: Selector<EncuestaProvider,
                                Tuple2<List<Enfermedad>, bool>>(
                              selector: (context, model) => Tuple2(
                                  model.enfermedades,
                                  model.loadingEnfermedades),
                            ...
                            onPressed: () {
                              if (_formKey.currentState.validate()) {
                                ...
                                if (_selectedItem == null) {
                                  Dialogs.mostrarDialog(context, "Error",
                                      "No seleccionó una Enfermedad");
                                  return;
                                }

                                Dialogs.mostrarLoadingDialog(
                                    context, _keyLoader, "Registrando");
                                UsuarioCtrl.insertEnfermedad(
                                        id_usuario, _selectedItem)
                                    .then((value) {
                                  print(value);
                                  Navigator.of(_keyLoader.currentContext,
                                      ...
                                      .pop();
                                  if (value == true) {
                                    Dialogs.mostrarDialog(context, "Éxito",
                                        "Se registró con éxito");
                                    setState(() {
                                      enfermedadesUsuario =
                                          UsuarioCtrl.enfermedadesUsuario(
                                              id_usuario);
                                    });
                                  } else {
                                    Dialogs.mostrarDialog(context, "Error",
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              trailing: new IconButton(
                                ...
                                onPressed: () {
                                  Dialogs.mostrarLoadingDialog(
                                      context, _keyLoader, "Eliminando");
                                  UsuarioCtrl.deleteEnfermedad(
                                          id_usuario, snapshot.data[index].id)
                                      .then((value) {
                                    Navigator.of(_keyLoader.currentContext,
                                            rootNavigator: true)
                                        .pop();
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  RaisedButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, '/estilos_vida',
