...
class _EstilosVidaState extends State<EstilosVida> {
  ...
  List<DropdownMenuItem> getSelectOptions(List<EstiloVida> als) {
    ...
    als.forEach((alergia) {
      ...
      list.add(
          new DropdownMenuItem(child: Text(alergia.nombre), value: alergia.id));
    });
    return list;
  }
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          IconButton(
                            ...
                            onPressed: () {
                              Navigator.pushNamed(
                                  context, "/registro_estilo_vida");
                            },
                          ),
                          Expanded(
                            child: Selector<EncuestaProvider,
                                Tuple2<List<EstiloVida>, bool>>(
                              selector: (context, model) => Tuple2(
                                  model.estilosVida, model.loadingEstilosVida),
                              ...
                              if (_formKey.currentState.validate()) {
                                ...
                                if (_selectedItem == null) {
                                  Dialogs.mostrarDialog(context, "Error",
                                      "No seleccionó un Estilo de Vida");
                                  return;
                                }

                                Dialogs.mostrarLoadingDialog(
                                    context, _keyLoader, "Registrando");
                                UsuarioCtrl.insertEstiloVida(
                                  ...
                                  if (value == true) {
                                    ...
                                    setState(() {
                                      estilosVidaUsuario =
                                          UsuarioCtrl.estilosVidaUsuario(
                                              id_usuario);
                                    });
                                  } else {
                                    Dialogs.mostrarDialog(context, "Error",
                            ...
                            child: ListTile(
                              ...
                              trailing: new IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  UsuarioCtrl.deleteEstiloVida(id_usuario,
