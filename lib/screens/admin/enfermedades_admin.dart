...
class _EnfermedadesAdminState extends State<EnfermedadesAdmin> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Admin Enfermedades'),
        centerTitle: true,
        elevation: 0.0,
      ),
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                ...
                mainAxisSize: MainAxisSize.max,
                children: <Widget>[
                  Selector<EncuestaProvider,Tuple2<List<Enfermedad>, bool>>(
                    selector: (context, model) => Tuple2(model.enfermedades, model.loadingEnfermedades),
