...
import 'package:cfhc/screens/admin/estilos_admin.dart';
import 'package:cfhc/screens/admin/ingredientes_admin.dart';
import 'package:cfhc/screens/admin/productos_categoria.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider<RestriccionProvider>(create: (context) => RestriccionProvider()),
        ChangeNotifierProvider<ProductoCategoriaProvider>(create: (context) => ProductoCategoriaProvider()),
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/estilos_admin' : (context) => EstilosAdmin(),
          '/productos_categoria' : (context) => ProductosCategoriaAdmin(),
          //'/productos_admin' : (context) => ProductosAdmin(),
