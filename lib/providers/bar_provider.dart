...
class BarProvider with ChangeNotifier {
  ...
  Future<bool> actualizarBar(Bar bar, File img) async {
    try {
      img.existsSync();
      ...
      final response = await Dio().post(GlobalVars.apiUrl + "bares/update/" + bar.id.toString(), data: formData, options: Options(
