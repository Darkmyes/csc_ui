  ...
  Widget getBarRow(Bar bar){
    return Card(
      child: ListTile(
        ...
        leading: bar.img == null ?
          FaIcon(FontAwesomeIcons.store, color:Colors.orange[400]) :
          AspectRatio(
            aspectRatio: 1,
            child: Image.network(GlobalVars.serverUrl + bar.img, fit: BoxFit.cover,),
          ),
        /* Icon(
          Icons.fastfood,
          size: 40,
          ...
          Expanded(
            ...
            child: Padding(
              ...
              child: bar.img != null ? 
                ...
                : Center(child: FaIcon(FontAwesomeIcons.store, size:64, color: Colors.orange[400],),)
            ),
          ),
