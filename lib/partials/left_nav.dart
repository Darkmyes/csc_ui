...
class LeftNav {
  ...
  Widget getLeftMenu2( BuildContext context/* , Usuario usuario */){
    ...
    RestriccionProvider restriccionesProv = Provider.of<RestriccionProvider>(context);
    ProductoCategoriaProvider categoriasProdProv = Provider.of<ProductoCategoriaProvider>(context);
          ...
          if (usuario != null && usuario.tipo == "Administrador") ... [
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.of(context).pushReplacementNamed('/productos_categoria');
              },
            ),
            ListTile(
